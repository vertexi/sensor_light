...
nmap π :call mdip#MarkdownClipboardImage()
...
set backupext=@2021-03-05.17:52
...
argglobal
%argdel
$argadd Rx_demo/Rx_demo.ino
set stal=2
tabnew
tabnew
tabnew
tabrewind
edit Rx_demo/Rx_demo.ino
...
setlocal makeprg=arduino\ --verify\ --board\ arduino:avr:uno\ --pref\ programmer=arduino:usbtinyisp\ --pref\ \"build.path=/home/apoptosis/Energia/Rx_demo/build\"\ --verbose-upload\ \"/home/apoptosis/Energia/Rx_demo/Rx_demo.ino\"
setlocal matchpairs=(:),{:},[:]
setlocal modeline
setlocal modifiable
...
silent! normal! zE
let s:l = 125 - ((29 * winheight(0) + 15) / 31)
...
setlocal nolist
setlocal makeencoding=
setlocal makeprg=arduino\ --verify\ --board\ arduino:avr:uno\ --pref\ programmer=arduino:usbtinyisp\ --pref\ \"build.path=/home/apoptosis/Energia/Tx_demo/build\"\ --verbose-upload\ \"/home/apoptosis/Energia/Tx_demo/Tx_demo.ino\"
setlocal matchpairs=(:),{:},[:]
setlocal modeline
setlocal modifiable
setlocal nrformats=bin,octal,hex
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 45 - ((10 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
45
normal! 011|
tabnext
edit ~/Energia/libraries/msp430_cc1101_energia_v2/CC1101_MSP430.cpp
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 663 - ((16 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
663
...
tabnext 4
set stal=1
badd +1 Rx_demo/Rx_demo.ino
badd +0 Tx_demo/Tx_demo.ino
badd +10 ~/Energia/libraries/msp430_cc1101_energia_v2/CC1101_MSP430.cpp
badd +12 libraries/msp430_cc1101_energia_v2/CC1101_MSP430.h
badd +0 log.md
